...
export default async function ArchetypePage({
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Sales Personality Types', item: 'https://thenobleseller.com/archetypes' },
      { '@type': 'ListItem', position: 3, name: archetype.name, item: `https://thenobleseller.com/archetypes/${archetype.slug}` },
    ],
  }
        ...
        <Container maxWidth="prose">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex flex-wrap items-center gap-2 font-sans text-xs text-[#6B6B6B]">
              ...
              <li>
                <Link href="/archetypes" className="hover:text-[#722F37] transition-colors">Sales Personality Types</Link>
              </li>
              <li aria-hidden="true">/</li>
              <li className="text-[#0F0F0F]" aria-current="page">{archetype.name}</li>
            </ol>
          </nav>
